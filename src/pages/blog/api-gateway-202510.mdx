...
To be fair, two of those days were the weekend but it was on my mind.
...
When you set up the custom hostname for API Gateway, you have to disable the default endpoint (https://jum813dn0n53n5e.execute-api.region.amazonaws.com), because the console tells you to.
