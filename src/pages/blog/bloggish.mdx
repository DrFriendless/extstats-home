...
When I say the blog is "serverless", what that means is that I am not paying for any sort of server to run it on.
The pages are hosted on AWS S3, which is like a big hard drive in the cloud, and S3 does the web server bit for me.