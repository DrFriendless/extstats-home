...
author: 'DrFriendless'
tags: ["features","AWS","technology","Vega","GraphQL"]
...
This time I didn’t need to upgrade any of the libraries, but I did discover that some of the data I wanted to display,
in particular whether you had a game for trade, was not available in the data set I was using, so I had to fix that.
